...
Rond::operator std::string() const {
    std::string result = "Rond[" + std::to_string(static_cast<int>(std::round(xCentre))) +"," + std::to_string(static_cast<int>(std::round(yCentre))) + "," + std::to_string(static_cast<int>(std::round(rayon))) + "]";
    return result;
}
